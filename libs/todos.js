...
$(function(){
  ...
  var Todo = Backbone.Model.extend({
    ...
    initialize: function() {
      if (!this.get("title")) {
        this.set({"title": this.defaults().title},{"director": this.defaults().title},{"year": this.defaults().title});
      }
    },
  ...
  var AppView = Backbone.View.extend({
    ...
    initialize: function() {
      ...
      Todos.fetch({ url: "/data/init.json"});
    },
    ...
    createOnClick: function() {
      ...
      Todos.create({title: Backbone.$('#new-title').val(), director: $('#new-director').val(), year: $('#new-year').val()});
      $('#new-title').val('');
      $('#new-director').val('');
      $('#new-year').val('');
